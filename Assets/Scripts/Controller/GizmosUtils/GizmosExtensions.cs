...
namespace Controller.GizmosUtils
{
    public static class GizmosExtensions
    {
        ...
        public static void DrawWireSphere(Vector3 center, float radius, Quaternion rotation = default(Quaternion))
        {
            ...
            UnityEngine.Gizmos.DrawWireSphere(Vector3.zero, radius);
            UnityEngine.Gizmos.matrix = old;
        }
            ...
            Quaternion rotation = default(Quaternion))
        {
            ...
            UnityEngine.Gizmos.DrawLine(-Vector3.forward * radius - Vector3.up * half,
